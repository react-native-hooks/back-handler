...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-back-handler.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-back-handler',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-back-handler.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-back-handler.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-back-handler.esm.js',
    }),
  ],
};
